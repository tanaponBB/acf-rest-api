<?php
/**
 * WooCommerce Tax Settings Handler
 *
 * Handles WooCommerce tax enable/disable functionality
...
class ACF_REST_WC_Tax_Settings {
     ...
     * Update tax status
     *
     * @param bool $enabled Enable or disable taxes
     * @return array
     */
    public function update_status($enabled) {
        ...
        return [
            ...
            'was_updated' => $updated,
            'message'     => $enabled
                ? __('Tax rates and calculations have been enabled.', 'acf-rest-api')
                : __('Tax rates and calculations have been disabled.', 'acf-rest-api'),
        ];
    }
    ...
    /**
     * REST API GET handler - Get tax status
     *
     * @param WP_REST_Request $request Request object
    ...
    /**
     * REST API POST handler - Update tax status
     *
     * @param WP_REST_Request $request Request object
     * @return WP_REST_Response
     */
